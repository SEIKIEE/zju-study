...
public class Assistance {
    ...
    throws IOException{
        ...
        */
        ...
        Configuration conf = new Configuration();
        FileSystem hdfs = FileSystem.get(conf);
        hdfs.copyToLocalFile(new Path(newpath), new Path("/user/hadoop/class/oldcenter"));
        hdfs.delete(new Path(oldpath), true);
        hdfs.moveFromLocalFile(new Path("/user/hadoop/class/oldcenter"), new Path(oldpath));
        return false;
    }
}